...
import Bottom from '@/components/templates/index/Bottom'
import GridContainer from '@/components/templates/index/GridContainer'
import GridItem from '@/components/templates/index/GridItem'
import Section from '@/components/templates/index/Section'
